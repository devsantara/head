...
describe('SchemaOrgBuilder', () => {
  ...
  describe('addEntity()', () => {
    it('should add entity with static value', () => {
      const schema = new SchemaOrgBuilder().addEntity('brand', {
        '@type': 'Brand',
        name: 'My Brand',
      });
    ...
    it('should return builder for chaining', () => {
      const schema = new SchemaOrgBuilder();
      const result = schema.addEntity('brand', { '@type': 'Brand' });
    ...
    it('should throw error when adding duplicate key', () => {
      ...
      expect(() => {
        ...
        schema.addEntity('brand', { '@type': 'Brand' });
      }).toThrow('Schema key "brand" already exists in the graph.');
    });

    it('should allow adding multiple entities with different keys', () => {
      const schema = new SchemaOrgBuilder()
        .addEntity('brand', { '@type': 'Brand', name: 'Brand A' })
        .addEntity('product', { '@type': 'Product', name: 'Product B' });
  ...
  describe('build()', () => {
    ...
    describe('multiple entities', () => {
      ...
      it('should maintain order of entities in graph', () => {
        const schema = new SchemaOrgBuilder()
          .addEntity('first', { '@type': 'Brand', name: 'First' })
          .addEntity('second', { '@type': 'Product', name: 'Second' })
          .addEntity('third', { '@type': 'Organization', name: 'Third' });
  ...
  describe('URL resolution', () => {
    ...
    it('should return URL as-is when no baseUrl provided', () => {
      const schema = new SchemaOrgBuilder().addEntity('brand', (_, helper) => ({
        '@type': 'Brand',
        '@id': helper.resolveUrl('/brand'),
      }));
  ...
  describe('schema-dts integration', () => {
    ...
    it('should work with Product type from schema-dts', () => {
      const schema = new SchemaOrgBuilder<Product>().addEntity('product', {
        '@type': 'Product',
    ...
    it('should work with Person type from schema-dts', () => {
      const schema = new SchemaOrgBuilder<Person>().addEntity('person', {
        '@type': 'Person',
        name: 'John Doe',
